...
func _process(delta):
	if len(SceneTransition.chose_two)==8 and flag:
		flag=false
		SceneTransition.transition_fade("res://05_Rezult.tscn")
...
func _on_Silver_pressed():
	...
	SceneTransition.chose_two.append("silver")
...
func _on_Blue_pressed():
	...
	yield(get_tree().create_timer(1), "timeout")
	#blue.visible=false
	SceneTransition.chose_two.append("blue")
...
func _on_Green_pressed():
	...
	yield(get_tree().create_timer(1), "timeout")
	#green.visible=false
	SceneTransition.chose_two.append("green")
...
func _on_Red_pressed():
	...
	yield(get_tree().create_timer(1), "timeout")
	#red.visible=false
	SceneTransition.chose_two.append("red")
...
func _on_Yellow_pressed():
	...
	SceneTransition.chose_two.append("yellow")
...
func _on_Pink_pressed():
	...
	yield(get_tree().create_timer(1), "timeout")
	#pink.visible=false
	SceneTransition.chose_two.append("pink")
...
func _on_Brown_pressed():
	...
	yield(get_tree().create_timer(1), "timeout")
	#brown.visible=false
	SceneTransition.chose_two.append("brown")
...
func _on_Black_pressed():
	...
	yield(get_tree().create_timer(1), "timeout")
	#black.visible=false
	SceneTransition.chose_two.append("black")
